...
struct Article : Hashable, Decodable, Identifiable{
    var id = UUID()
...
struct MockArticleData {
    ...
    static let sampleArticle1  = Article(source: ArticleSource(id: "bbc-news", name: "BBC News"),
                                        author: "BBC News",
    ...
    static let sampleArticle2  = Article(source: ArticleSource(id: "bbc-news", name: "BBC News"),
                                        author: "BBC News",
